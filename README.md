...
| **#7: Flexibility and efficiency of use**: Shortcuts — hidden from novice users — may speed up the interaction for the expert user such that the design can cater to both inexperienced and experienced users. Allow users to tailor frequent actions. | 1 | **Good**: The drop down menu is easily identified. Each menu tab has several distinct sub-tabs. **Bad**: The sub-tabs can be classified into more subdivisions to make it even easier for users to nagivate to the page that they want. | Include subdivisions for sub-tabs to make the information more locatable. |
